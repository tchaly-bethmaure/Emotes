...
experiment expFictitiousPlay type: gui {
	...
	user_command get_agent_info action: expose_yourself;
	...
	parameter 'Reward (R)' var: R <- 4 min: 0 max:10 category: 'Prisoner dilemna';
	parameter 'Temptation (T)' var: T <- 6 min: 0 max:10 category: 'Prisoner dilemna';	
